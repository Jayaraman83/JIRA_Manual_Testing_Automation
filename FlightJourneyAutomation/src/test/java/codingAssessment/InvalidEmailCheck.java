...
public class InvalidEmailCheck {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("email-input")).sendKeys("test123j"); //This confirms that email input field is email-input
		...
		String actualValidationMsg = driver.findElement(By.xpath("//div[@class='validation error']")).getText();
		System.out.println(actualValidationMsg);
		
		if(actualValidationMsg.equals("Enter a valid email")) {
			System.out.println("Expected Validation Message matches with Actual Validation Message");
		}
